...
const initialState = {
	questions: [
		...
		},
		{
			...
			options: ["Pacifique", "Atlantique", "Arctique", "Indien"],
		...
		},
		{
			...
			options: ["Or", "Oxygène", "Osmium", "Hydrogène"],
...
const reducer = (state, action) => {
	switch (action.type) {
		case "answer":
			if (
				action.answer == state.questions[state.currentQuestion].correctAnswer
			) {
				return {
					...state,
					score: state.score + 1,
...
const useQuizzReducer = () => useReducer(reducer, initialState);
